...
from apps.utilidade.validador_cpf import valida_cpf
from apps.utilidade.validators.validators import (caract_especiais_validador,
                                             string_validador,
                                             tamanho_len_validador)
from apps.utilidade.validators.validators import (espaços_vazio_validador,
                                             digitos_validador,
